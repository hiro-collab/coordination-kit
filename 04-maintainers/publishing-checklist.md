...
- [ ] `AGENTS.md` gives Codex, GitHub Agents, and other coding agents a concise repository entry point.
- [ ] `.github/` contains current contributor, pull request, issue, and Copilot guidance if the repository is public on GitHub.
...
- [ ] Repository About text matches the generic kit positioning and does not describe only a competitive-trial profile.
